/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46ecfca473fbd84ebce204247f0d5b23)
// Runtime types generated with workerd@1.20260701.1 2026-07-04 nodejs_compat
interface __BaseEnv_Env {
	GITHUB_OWNER: "coup-d-etat-pinkgorilla";
	GITHUB_REPO: "planner_of_plana";
	REPORTING_ENABLED: "false" | "true";
	REPORT_RATE_LIMITER: DurableObjectNamespace<import("./src/index").ReportRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReportRateLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OWNER" | "GITHUB_REPO" | "REPORTING_ENABLED">> {}
}
