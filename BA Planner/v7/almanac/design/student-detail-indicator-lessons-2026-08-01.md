...
43.2px이고 하단 잔여 공간에서 측정한 실제 수평 span의 중앙에 정렬한다. 이전의 폭 기반
3~8px 좌측 optical shift는 실화면에서 숫자가 왼쪽에 붙어 보이게 해 제거했다.
...
| 랭크 숫자 수평 위치 | 실제 하단 span 중앙, 추가 이동 없음 |
| 랭크 글자 크기 | 43.2px |
...
- 랭크 숫자가 compact와 wide 모두 실제 하단 span 중앙에 놓이는지 확인한다.
