...
class _RepositoryProfilePanelState extends State<RepositoryProfilePanel> {
  ...
  Future<void> _create() async {
    ...
    if (name == null) return;
    try {
      await _repository!.createProfile(name, _key('create'));
      await _reload();
    } catch (error) {
      if (mounted) setState(() => _error = error.toString());
    }
  ...
  Future<void> _rename() async {
    ...
    if (name == null) return;
    try {
      await _repository!.renameProfile(
        profile.id,
        name,
        profile.revision,
        _key('rename'),
          ...
          children: [
            ...
            Expanded(
              child: DropdownButtonHideUnderline(
                child: DropdownButton<RepositoryProfile>(
                  value: selected,
            ...
            IconButton(
              ...
              tooltip: '이름 변경',
              onPressed: selected == null || _loading ? null : _rename,
