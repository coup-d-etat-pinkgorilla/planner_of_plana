...
class RepositoryProtocolContractTests(unittest.TestCase):
    ...
    def test_nested_schema_matches_python_dto_owners(self) -> None:
        ...
        cases = [
            ...
            ("inventory-zero", request("repository.inventory.update", "inventory", {"version": 1, "entries": [{"key":"x","quantity":"0"}]}), lambda: InventorySnapshot.from_dict({"version": 1, "entries": [{"key":"x","quantity":"0"}]}), True),
            ("inventory-negative", request("repository.inventory.update", "inventory", {"version": 1, "entries": [{"key":"x","quantity":"-1"}]}), lambda: InventorySnapshot.from_dict({"version": 1, "entries": [{"key":"x","quantity":"-1"}]}), False),
            ("inventory-leading-zero", request("repository.inventory.update", "inventory", {"version": 1, "entries": [{"key":"x","quantity":"01"}]}), lambda: InventorySnapshot.from_dict({"version": 1, "entries": [{"key":"x","quantity":"01"}]}), False),
            ("inventory-nonascii-digit", request("repository.inventory.update", "inventory", {"version": 1, "entries": [{"key":"x","quantity":"١"}]}), lambda: InventorySnapshot.from_dict({"version": 1, "entries": [{"key":"x","quantity":"١"}]}), False),
